...
extension ExamplesViewController {
    func createInstreamView() {
        ...
        instreamView = AUInstreamView(
            configId: storedImpVideo,
            adSize: adSize,
            isLazyLoad: false
        )
        instreamView.frame = CGRect(
    ...
    func setupPlayerForInstreamExample() {
        ...
        playButton = UIButton(
            frame: CGRect(
                x: instreamView.frame.width / 2 - 42,
    ...
    @objc func onPlayButtonPressed(_ sender: AnyObject) {
        ...
        instreamView.onLoadInstreamRequest = { [weak self] keywords in
            ...
            do {
                let adServerTag = try AUIMAUtils.shared
