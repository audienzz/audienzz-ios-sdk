Pod::Spec.new do |spec|
    ...
    # Analytics reads bid economics from the Prebid targeting keywords + the GMA paid event, so it
    # works identically on SPM and CocoaPods against stock PrebidMobile (no fork required).
