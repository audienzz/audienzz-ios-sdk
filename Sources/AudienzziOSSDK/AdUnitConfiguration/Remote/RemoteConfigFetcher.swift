...
final class RemoteConfigFetcher {
    ...
    func fetchPublisherConfig(remoteUrl: URL, publisherId: String) async throws -> [RemoteAdConfiguration] {
        try await fetch(
            remoteUrl: remoteUrl,
    ...
    func fetchBannerConfig(remoteUrl: URL, publisherId: String, adConfigId: String) async throws -> RemoteAdConfiguration {
        try await fetch(
            remoteUrl: remoteUrl,
