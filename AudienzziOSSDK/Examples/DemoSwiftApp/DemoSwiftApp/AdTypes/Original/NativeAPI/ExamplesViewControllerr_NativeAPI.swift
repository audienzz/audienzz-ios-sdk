...
extension ExamplesViewController {
    ...
    func createNativeBannerView() {
        ...
        gamBannerView.frame = CGRect(origin: .zero, size: CGSize(width: self.view.frame.width, height: 250))
    ...
    internal func nativeConfiguration() -> AUNativeRequestParameter {
        ...
        parameters.eventtrackers = [AUNativeEventTracker(event: AUEventType.Impression,
                                                         methods: [AUEventTracking(trackingType: .Image),
...
extension ExamplesViewController {
    ...
    func createLazyNativeBannerView() {
        ...
        nativeLazyBannerView.frame = CGRect(x: 0, y: getPositionY(lazyAdContainerView), width: self.view.frame.width, height: 250)
...
extension ExamplesViewController: GADAdLoaderDelegate, GADCustomNativeAdLoaderDelegate {
    ...
    func adLoader(_ adLoader: GADAdLoader, didReceive customNativeAd: GADCustomNativeAd) {
        if adLoader == self.adLoader {
            ...
            AudienzzGAMUtils.shared.findCustomNativeAd(for: customNativeAd, completion: { [weak self] ad, error in
