...
extension ExamplesViewController {
    func createInstreamView() {
        ...
        instreamView.frame = CGRect(origin: CGPoint(x: 0, y: getPositionY(adContainerView)), size: CGSize(width: view.frame.size.width, height: 480))
    ...
    func setupPlayerForInstreamExample() {
        ...
        playButton = UIButton(frame: CGRect(x: instreamView.frame.width / 2 - 42,
                                            y: instreamView.frame.height / 2 - 62,
                                            width: 85, height: 125))
        ...
        instreamView.addGestureRecognizer(tapGesture)
