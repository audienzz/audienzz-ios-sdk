...
typedef SWIFT_ENUM_NAMED(NSInteger, AUAdInterstitialPosition, "AUAdInterstitialPosition", open) {
...
///   </li>
/// </ul>
typedef SWIFT_ENUM_NAMED(NSInteger, AUAdPosition, "AUAdPosition", open) {
...
@protocol AUAdUnitConfigurationType <AUAdUnitConfigurationAutorefreshProtocol, AUAdUnitConfigurationGRIPProtocol, AUAdUnitConfigurationSlotProtocol>
@end
...
///
/// \endcode
typedef SWIFT_ENUM_NAMED(NSInteger, AUApiType, "AUApiType", open) {
  AUApiTypeVPAID_1 = 1,
  AUApiTypeVPAID_2 = 2,
  AUApiTypeMRAID_1 = 3,
  AUApiTypeORMMA = 4,
...
@property (nonatomic, strong) AUVideoParameters * _Nullable videoParameters;
...
typedef SWIFT_ENUM(NSInteger, AUContextSubType, open) {
...
typedef SWIFT_ENUM(NSInteger, AUContextType, open) {
...
typedef SWIFT_ENUM(NSInteger, AUDataAsset, open) {
...
typedef SWIFT_ENUM(NSInteger, AUEventTrackingType, open) {
  AUEventTrackingTypeImage = 1,
  AUEventTrackingTypeJs = 2,
  AUEventTrackingTypeCustom = 500,
};

typedef SWIFT_ENUM(NSInteger, AUEventType, open) {
...
typedef SWIFT_ENUM(NSInteger, AUImageAsset, open) {
  AUImageAssetIcon = 1,
  AUImageAssetMain = 3,
...
typedef SWIFT_ENUM(NSInteger, AUNativeDataAssetType, open) {
...
typedef SWIFT_ENUM(NSInteger, AUNativeImageAssetType, open) {
...
typedef SWIFT_ENUM(NSInteger, AUNativeType, open) {
...
///
/// \endcode
typedef SWIFT_ENUM_NAMED(NSInteger, AUPlacement, "AUPlacement", open) {
...
typedef SWIFT_ENUM(NSInteger, AUPlacementType, open) {
...
typedef SWIFT_ENUM(NSInteger, AURenderingInsterstitialAdFormat, open) {
  AURenderingInsterstitialAdFormatBanner = 0,
  AURenderingInsterstitialAdFormatVideo = 1,
};

typedef SWIFT_ENUM(NSInteger, AUResultCode, open) {
...
@class CLLocation;
SWIFT_CLASS("_TtC14AudienzziOSSDK11AUTargeting")
@interface AUTargeting : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, strong) AUTargeting * _Nonnull shared;)
+ (AUTargeting * _Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
+ (void)setShared:(AUTargeting * _Nonnull)value;
...
@property (nonatomic, copy) NSArray<NSDictionary<NSString *, id> *> * _Nullable eids;
/// Placeholder for exchange-specific extensions to OpenRTB.
...
///
/// \endcode
typedef SWIFT_ENUM(NSInteger, AUVideoPlaybackMethodType, open) {
...
///
/// \endcode
typedef SWIFT_ENUM(NSInteger, AUVideoProtocolsType, open) {
...
///
/// \endcode
typedef SWIFT_ENUM_NAMED(NSInteger, AUVideoStartDelay, "AUVideoStartDelay", open) {
...
- (void)configureSDKWithCompanyId:(NSString * _Nonnull)companyId;
- (void)configureSDKWithCompanyId:(NSString * _Nonnull)companyId gadMobileAdsVersion:(NSString * _Nullable)gadMobileAdsVersion;
/// Special method used for RN bridging initialization
- (void)configureSDK_RNWithCompanyId:(NSString * _Nonnull)companyId :(void (^ _Nullable)(void))completion;
/// Special method used for RN bridging initialization
- (void)configureSDK_RNWithCompanyId:(NSString * _Nonnull)companyId gadMobileAdsVersion:(NSString * _Nullable)gadMobileAdsVersion :(void (^ _Nullable)(void))completion;
...
@interface ExternalUserId (SWIFT_EXTENSION(AudienzziOSSDK))
+ (ExternalUserId * _Nullable)fromJson:(NSDictionary<NSString *, id> * _Nonnull)json SWIFT_WARN_UNUSED_RESULT;
@end

@interface UserUniqueID (SWIFT_EXTENSION(AudienzziOSSDK))
+ (UserUniqueID * _Nullable)fromJson:(NSDictionary<NSString *, id> * _Nonnull)json SWIFT_WARN_UNUSED_RESULT;
@end
