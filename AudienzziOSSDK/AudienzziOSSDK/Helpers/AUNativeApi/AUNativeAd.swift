...
public class AUNativeAd: NSObject {
    ...
    public var nativeAdMarkup: AUNativeAdMarkup? {
        AUNativeAdMarkup(nativeAdMarkup: nativeAd.nativeAdMarkup)
    }
    ...
    @objc public func dataObjects(of dataType: AUNativeDataAssetType)
        -> [AUNativeData]
    {
        dataObjects.filter { $0.type == dataType.rawValue }
    }

    @objc public func images(of imageType: AUNativeImageAssetType)
        -> [AUNativeImage]
    {
